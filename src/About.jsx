  ...
  return (
    <div className="mt-8 flex flex-col items-center gap-8 p-8 w-full min-h-screen ">
      <section className="flex flex-col items-center gap-2 w-full">
        <h2 className="text-2xl md:text-3xl font-bold">About Our Services</h2>
        <img
          src="../Rectangle-6.png"
      ...
      <div className=" flex flex-col md:flex-row items-start justify-center gap-10 p-8 min-h-[35vh] w-full">
        <img
        ...
        <section className="flex flex-col gap-2 text-center  items-start md:text-left max-w-xl">
          <p className="  text-lg md:text-2xl  text-left  leading-relaxed max-w-xl md:ml-6 ">
